package com.mobdeve.s11.medina.tacorda.four

object GameObject {

    //Board and Chip Mechanics
    ...
    fun dropChip() {
        ...
        if (colDepth >= 0) {
            ...
            currCol = rnds
            val colDepth2 = getLastEmptyUnit(currCol)
            field[colDepth2][currCol] = currTurn
            updateWinLine(currCol, colDepth2)
    ...
    //Updates the current longest line in the board
